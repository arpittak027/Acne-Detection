...
const CaptureImage: React.FC = () => {
  ...
  const analyzeImage = async (imageSrc: string) => {
    ...
    try {
      ...
      const detectionResult = await detectAcneFromImage(imageSrc);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Capture Image</h1>
        <p className="text-gray-600 mt-1">
          Take a photo of your skin for acne analysis
        </p>
      </div>
        ...
        {!capturedImage && !analysisResult ? (
          ...
          <div className="p-6 text-center">
            ...
            <img 
              src={capturedImage || ''} 
              alt="Captured skin" 
              className="mt-6 max-h-96 mx-auto rounded-lg shadow-sm"
            />
          </div>
        ) : analysisResult ? (
          <div className="p-6">
